...
PER_QUERY      = 500
REQUEST_BUDGET = 13           # per-run cap (AVM + up to 10 state queries + region queries).
                              # ~4.3 weekly runs/mo keeps you near RentCast's free 50/mo; cap prevents runaway.
...
REGION_QUERIES = [
    dict(name="Eastern NC coastal plain", lat=35.25, lon=-77.35, radius=90, types=["Land"]),
]
